                                ...
                                <div>
                                    <h5 class="mb-0 fw-semibold d-flex align-items-center gap-2">
                                        <span class="d-inline-flex align-items-center justify-content-center bg-primary rounded-2 text-white" style="width:30px; height:30px;">
                                            <i class="ti ti-scale" style="font-size:1rem;"></i>
                                        </span>
                                        Units
                                    </h5>
                                </div>
                                <div>
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#createUnitModal" class="btn btn-primary d-flex align-items-center gap-1 px-3" style="height: 38px; border-radius: 8px; font-size: 0.85rem;">
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-header border-0 bg-transparent py-3 px-4 pb-0">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                ...
                                <div class="position-relative mx-auto" style="width: 100%; max-width: 320px;">
                                    <input type="text" id="userTableSearch" class="form-control" placeholder="Search units..." style="border: 1.5px solid #e2e8f0; border-radius: 8px; padding: 7px 14px 7px 36px; font-size: 0.85rem; outline: none; transition: border-color 0.2s; height: 38px; width: 100%;">
                        ...
                        <div class="card-body px-4 pt-3">
                            <div class="table-responsive">
                                <table id="units-table" class="table mb-0 w-100">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Name</th>
